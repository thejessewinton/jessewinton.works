...
export const Footer = () => {
  return (
    <footer className="mt-auto mb-0 flex h-20 w-full animate-blur items-center px-4 py-8">
      <div className="mx-auto flex w-full max-w-4xl flex-row items-center justify-between gap-4 text-neutral-500">
