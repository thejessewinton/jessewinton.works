  ...
  return (
    <div className="flex flex-col gap-2 pb-4">
      <div className="relative z-50 animate-enter">
        ...
        <div
          className="prose prose-neutral dark:prose-invert max-w-none font-light prose-a:font-normal prose-a:no-underline"
          dangerouslySetInnerHTML={{ __html: index.html }}
        />
      </div>

      {index.works ? (
        <div className="group animation-delay-300 pointer-events-none relative my-12 flex flex-col gap-12">
          {index.works.map((work, i) => (
            ...
            >
              <Link
                ...
                className="md:hover:opacity-100! md:hover:blur-none! relative block min-h-[90px] font-light transition-all md:group-hover:opacity-40 md:group-hover:blur-xs"
              >
                <h2 className="mb-5 text-neutral-900 text-sm dark:text-neutral-400">
                  {work.label}
                </h2>
