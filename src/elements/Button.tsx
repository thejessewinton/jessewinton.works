...
export const Button = forwardRef(
  (
    ...
    const buttonStyles = css(
      "py-3 px-6 max-h-12 font-bold cursor-pointer flex items-center justify-center rounded transition-all bg-gray-400 text-gray-100 gap-3 text-xs lg:text-lg hover:bg-transparent hover:border-gray-400 border border-solid border-transparent relative overflow-hidden hover:bg-gray-100 hover:text-white transition-all disabled:cursor-not-allowed",
      className
    );
